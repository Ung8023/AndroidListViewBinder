...
import com.ung8023.recyclerbinder.BaseRecyclerDataBinder;
...
public class MyRecyclerViewDataBinder extends BaseRecyclerDataBinder<DataEntity> {
    @Override
    public void bindViewData(ViewWrapper viewHolder, DataEntity data, int position) {
    ...
    void bindCommonData(ViewWrapper viewHolder, DataEntity data) {
